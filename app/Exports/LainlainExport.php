...
class LainlainExport implements FromView,WithCustomStartCell,ShouldAutoSize
{
    use Exportable;
    ...
    {
        $data['list']=JobLainnya::with(['user'])
        ...
        return view('admin.lainlain.laporan', ['data' => (object)$data]);
    }
