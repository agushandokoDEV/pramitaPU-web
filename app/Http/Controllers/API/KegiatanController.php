...
class KegiatanController extends Controller
{
    public function bydate(Request $request)
    {
        ...
        $data=Kegiatan::with(['ambilbahan','antarbahan','instansi','pengantarandokter','pengantarandokter.dokter','lab','lainnya'])
    ...
    public function byid(Request $request,$id)
    {
        ...
        $kegiatan=Kegiatan::with(['ambilbahan','lab','instansi','pengantarandokter','antarbahan','lainnya','pengantarandokter.uraianterpilih','pengantarandokter.dokter','pengantarandokter.uraianterpilih.jenis'])
            ->where('id',$id)
            ->first();
        if($kegiatan){
